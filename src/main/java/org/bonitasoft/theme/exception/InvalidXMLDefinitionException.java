...
public class InvalidXMLDefinitionException extends Exception {
     ...
     */
    public InvalidXMLDefinitionException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message message associated with the exception
     */
    public InvalidXMLDefinitionException(final String message) {
        super(message);
    }
     ...
     * @param cause cause of the exception
     */
    public InvalidXMLDefinitionException(final Throwable cause) {
        super(cause);
    }
}